...
function JobsPage() {
  const [jobs, setJobs] = useState([
    ...
    },
    {
      ...
      description: "Experienced Project Manager needed for overseeing key client projects.",
    },
    {
      id: 3,
      title: "Data Analyst",
      URL: "https://datacorp.com/job3",
      description: "Seeking a skilled Data Analyst to work with large datasets and derive insights.",
    },
  ]);
  ...
  const handleCreateJob = () => {
    if (newJob.title.trim() !== "" && newJob.URL.trim() !== "" && newJob.description.trim() !== "") {
      const newEntry = {
        ...newJob,
        id: jobs.length + 1,
      };
    ...
    <div className="space-y-4">
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        {filteredJobs.map((job) => (
          <div key={job.id} className="bg-white rounded-lg shadow-md p-4 mt-4">
